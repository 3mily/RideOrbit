...
Place.create(
  ...
  cross_street_point: {"name": "Home - No 3 Rd and Cooke","lat": 49.166522, "long": -123.136471}
  )
...
Place.create(
  ...
  cross_street_point: {"name": "Work - Seymour and Dunsmuir","lat": 49.283003, "long": -123.115422}
  )
