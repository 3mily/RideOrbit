...
1.upto(10) do |i|
  User.create(firstname: "firstname#{i}",lastname:"lastname#{i}",phone:"555-555#{i}",password:"pwpwpw",email:"email@email#{i}", picture: "https://avatars2.githubusercontent.com/u/3858222?v=3&s=460") 
end
